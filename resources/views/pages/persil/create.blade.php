...
@section('content')
    <div class="container mt-4">
        ...
        <form method="POST" action="{{ route('persil.store') }}">
            ...
            <div class="mb-3">
                <label>Luas (m²)</label>
                <input type="number" step="0.01" name="luas_m2" value="{{ old('luas_m2') }}" class="form-control">
            </div>

            <div class="mb-3">
                <label>Penggunaan</label>
                <input type="text" name="penggunaan" value="{{ old('penggunaan') }}" class="form-control">
            </div>

            <div class="mb-3">
                <label>Alamat Lahan</label>
                <input type="text" name="alamat_lahan" value="{{ old('alamat_lahan') }}" class="form-control">
            </div>

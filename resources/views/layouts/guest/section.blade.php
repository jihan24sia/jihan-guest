        ...
        <div class="banner_section layout_padding">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <h1 class="about_taital"
                                        style="font-size:36px; font-weight:700; color:#ff5e8e; margin-bottom:20px;">
                                        Bina Desa
                                    </h1>
                                    <p class="banner_text"
                                        style="color:#555; line-height:1.7; font-size:16px; margin-bottom:25px;">Sistem
                                        ini dibuat untuk membantu pemerintah desa dalam mengelola data pertanahan atau
                                        persil warga secara
                                        digital.
                                        Melalui sistem ini, data tanah, pemilik, batas wilayah, dan riwayat kepemilikan
                                        dapat didokumentasikan
                                        dengan rapi,
                                        sehingga proses administrasi pertanahan menjadi lebih mudah, cepat, dan
                                        transparan.
                                        Dirancang dengan tampilan yang sederhana dan modern agar dapat digunakan oleh
                                        perangkat desa tanpa kesulitan
                                        teknis.</p>

                                </div>
                                <div class="col-sm-5">
                                    <div class="banner_img"><img
                                            src="{{ asset('assets/guest/images/banner-img.png') }}"></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="cream_section layout_padding">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="cream_taital">Our Dokumentation</h1>
                            <p class="cream_text">All the info you need — simple, clear, and easy to follow.</p>
                        </div>
                    </div>
                    <div class="cream_section_2">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="cream_box">
                                    <div class="cream_img"><img src="{{ asset('assets/guest/images/img-1.jpg') }}">
                                    </div>
                                    <div class="price_text">2018</div>
                                    <h6 class="strawberry_text">Desa Handil Purai</h6>
                                  <a>Membantu Meringankan</a>
                                   <a>Beban Masyarakat di Bidang Pangan.</a>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="cream_box">
                                    <div class="cream_img"><img src="{{ asset('assets/guest/images/img-3.jpg') }}">
                                    </div>
                    ...
                    <div class="cream_section_2">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="cream_box">
                                    <div class="cream_img"><img src="{{ asset('assets/guest/images/img-4.jpg') }}">
                                    </div>
                                    <div class="price_text">$10</div>
                                    <h6 class="strawberry_text">Strawberry Ice Cream</h6>
                                    <div class="cart_bt"><a href="#">Add To Cart</a></div>
                            ...
                            <div class="col-md-4">
                                <div class="cream_box">
                                    <div class="cream_img"><img src="{{ asset('assets/guest/images/img-4.png') }}">
                                    </div>
                                    <div class="price_text">$10</div>
                                    <h6 class="strawberry_text">Strawberry Ice Cream</h6>
                                    <div class="cart_bt"><a href="#">Add To Cart</a></div>
                            ...
                            <div class="col-md-4">
                                <div class="cream_box">
                                    <div class="cream_img"><img src="{{ asset('assets/guest/images/img-5.png') }}">
                                    </div>
                                    <div class="price_text">$10</div>
                                    <h6 class="strawberry_text">Strawberry Ice Cream</h6>
                                    <div class="cart_bt"><a href="#">Add To Cart</a></div>
                    ...
                    <div class="services_section_2">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="services_box">
                                    <h5 class="tasty_text"><span class="icon_img"><img
                                                src="{{ asset('assets/guest/images/icon-1.png') }}"></span>Cookies Ice
                                        Cream</h5>
                            ...
                            <div class="col-md-4">
                                <div class="services_box">
                                    <h5 class="tasty_text"><span class="icon_img"><img
                                                src="{{ asset('assets/guest/images/icon-2.png') }}"></span>Cookies Ice
                                        Cream</h5>
                                    <p class="lorem_text">commodo consequat. Duis aute irure dolor in reprehenderit in
                                        voluptate velit esse cillum dolore eu fat </p>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="services_box">
                                    <h5 class="tasty_text"><span class="icon_img"><img
                                                src="{{ asset('assets/guest/images/icon-3.png') }}"></span>Cookies Ice
                                        Cream</h5>
                                    <p class="lorem_text">commodo consequat. Duis aute irure dolor in reprehenderit in
                                        voluptate velit esse cillum dolore eu fat </p>
                                </div>
